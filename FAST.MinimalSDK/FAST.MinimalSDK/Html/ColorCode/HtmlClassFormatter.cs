...
namespace FAST.Html.ColorCode
{
    ...
    /// </summary>
    internal /*public*/ class HtmlClassFormatter : CodeColorizerBase
    {
        /// <summary>
        ...
        public string GetCSSString()
        {
            ...
            foreach (var style in Styles)
            {
                ...
                if (!string.IsNullOrWhiteSpace(style.Foreground))
                    str.Append($"color:{htmlColorHelper.toHtmlColor(style.Foreground)};");

                if (!string.IsNullOrWhiteSpace(style.Background))
                    str.Append($"color:{htmlColorHelper.toHtmlColor(style.Background)};");
