...
namespace FAST.Core
{
    ...
    public static class anonymousHelper
    {
        ...
        private static readonly AssemblyBuilder AssemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName(nameof(anonymousHelper)),
                                                                                                        AssemblyBuilderAccess.RunAndCollect);
        private static readonly ModuleBuilder moduleBuilder = AssemblyBuilder.DefineDynamicModule(nameof(anonymousHelper));
        ...
        public static object CreateObject(IDictionary<string, object> valueDictionary)
        {
            ...
            var anonymousType = anonymousHelper.CreateType(typeDictionary.ToFastKeyValuePairs());
        ...
        public static Type CreateType(IEnumerable<FastKeyValuePair<string, Type>> typePairs)
        {
        ...
        /// <returns>the anonymous type</returns>
        public static Type CreateType(IEnumerable<FastKeyValuePair<string, Type>> typePairs, bool isMutable)
        {
        ...
        /// <returns>the anonymous type</returns>
        public static Type CreateType(IEnumerable<FastKeyValuePair<string, Type>> typePairs, bool isMutable, Type parent)
        {
        ...
        private static Type CreateGenericTypeDefinitionNoLock(string genericTypeDefinitionName, ICollection<string> propertyNames, bool isMutable, Type parent)
        {
            ...
            var typeParameterPairs = propertyNames.Zip(typeParameters,
                (propertyName, typeParameter) => new FastKeyValuePair<string, GenericTypeParameterBuilder>(propertyName, typeParameter)
            ).ToArray();
            ...
            var fieldPairs = propertyNames.Zip(fieldBuilders,
                (propertyName, fieldBuilder) => new FastKeyValuePair<string, FieldBuilder>(propertyName, fieldBuilder)
            ).ToArray();
        ...
        private static void DefineToStringMethod(TypeBuilder typeBuilder, IEnumerable<FastKeyValuePair<string, FieldBuilder>> fieldPairs)
        {
        ...
        public static FieldInfo CreateField<T>(T value)
        {
