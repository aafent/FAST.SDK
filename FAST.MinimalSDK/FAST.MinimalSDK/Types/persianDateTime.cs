...
namespace FAST.Types
{
    ...
    // This class also contains most of the methods and properties of the conventional DateTime class such as DateTime.Now 
    // and DateTime.TimeOfDay.
    // original code has modified, refactored and added to the FAST Libraries.
    ...
    public class persianDateTime
    {
        ...
        private bool isInDaylightSavingTime
        {
            get
            {
                TimeSpan _timeOfYear = timeOfYear;
                return _timeOfYear > daylightSavingTimeStart && timeOfYear < daylightSavingTimeEnd;
            }
        }
        ...
        {
            return new persianDateTime(_dateTime.AddYears(value));
        }
        ...
        {
            return new persianDateTime(_dateTime.AddMonths(months));
        }
        ...
        public string ToString(persianDateTimeFormat format)
        {
            switch (format)
            {
                ...
                case persianDateTimeFormat.dateTime:
                    return ToString(persianDateTimeFormat.date) + " " + datesHelper.toHHMMSS(timeOfDay);

                case persianDateTimeFormat.dateShortTime:
                    return ToString(persianDateTimeFormat.date) + " " + datesHelper.toHHMM(timeOfDay);

                case persianDateTimeFormat.longDate:
                    return dayName + " " + day + " " + monthName;

                case persianDateTimeFormat.longDateFullTime:
                    return dayName + " " + day + " " + monthName + " ساعت " + datesHelper.toHHMMSS(timeOfDay);

                case persianDateTimeFormat.longDateLongTime:
                    return dayName + " " + day + " " + monthName + " ساعت " + datesHelper.toHHMM(timeOfDay);

                case persianDateTimeFormat.shortDateShortTime:
                    return day.ToString() + " " + monthName + " " + datesHelper.toHHMM(timeOfDay);

                case persianDateTimeFormat.fullDate:
                    return dayName + " " + day + " " + monthName + " " + year;

                case persianDateTimeFormat.fullDateLongTime:
                    return dayName + " " + day + " " + monthName + " " + year + " ساعت " + datesHelper.toHHMM(timeOfDay);

                case persianDateTimeFormat.fullDateFullTime:
                    return dayName + " " + day + " " + monthName + " " + year + " ساعت " + datesHelper.toHHMMSS(timeOfDay);
